/**
 * Astar Card Component
 * 
 * Displays ASTR balance and information from Astar Network.
 */
...
import { queryAstarBalance, getAstarConfig } from '@/lib/chains/astar';
import { formatBalance, formatUSD } from '@/lib/utils/formatters';
import { ExternalLink, RefreshCw } from 'lucide-react';

export function AstarCard() {
      ...
      <CardContent>
        ...
        <div className="mt-4 flex items-center justify-between">
          <a
            ...
            className="flex items-center gap-2 text-sm text-[var(--text-secondary)] hover:text-[var(--astar-blue)] transition-colors"
          >
